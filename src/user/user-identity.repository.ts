...
/**
 * Repository for the centralized users/user_identities tables
 * (database/migrations/011, 012). Deliberately placed under
 * src/user/, not src/telegram/ - this is the channel-agnostic User &
 * Preference Engine slice per
 * docs/architecture/GDN_User_Preference_Architecture.md, and must
 * stay reusable by the future Web app, Mini App, and WhatsApp
 * integrations without moving code around.
 */
